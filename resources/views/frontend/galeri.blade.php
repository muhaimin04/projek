...
<body>
	...
	<!-- Page info section -->
	<section class="page-info-section set-bg" data-setbg="{{ asset ('assets/frontend/img/page-top-bg/4.jpg') }}">
	...
	<!-- Page section -->
	<section class="page-section community-page set-bg" data-setbg="{{ asset ('assets/frontend/img/community-bg.jpg') }}">
				...
				<ul class="community-post-list">
					<li>
						<div class="community-post">
							<div class="author-avator set-bg" data-setbg="{{ asset ('assets/frontend/img/authors/1.jpg') }}"></div>
					...
					<li>
						<div class="community-post">
							<div class="author-avator set-bg" data-setbg="{{ asset ('assets/frontend/img/authors/8.jpg') }}"></div>
							<div class="post-content">
								<h5>Partik Williams<span>posted an update</span></h5>
								<div class="post-date">June 21, 2018</div>
								<p>Lorem ipsum dolor sit amet, cdictum nisl onsectetur adipisc ing ipsum dolor sit ame. Lorem ipsum dolor sit amet, consectetur adipisc ing ipsum dolor sit ame.Donec venenatis at eros sit amet aliquam. Donec vel orci efficitur, dictum nisl vitae, scelerisque nibh. Curabitur eget ipsum pulvinar nunc gravida interdum. </p>
								<div class="attachment-file">
									<img src="{{ asset ('assets/frontend/img/attachment.jpg') }}" alt="">
								</div>
							</div>
						</div>
					</li>
					<li>
						<div class="community-post">
							<div class="author-avator set-bg" data-setbg="{{ asset ('assets/frontend/img/authors/5.jpg') }}"></div>
							<div class="post-content">
					...
					<li>
						<div class="community-post">
							<div class="author-avator set-bg" data-setbg="{{ asset ('assets/frontend/img/authors/4.jpg') }}"></div>
							<div class="post-content">
								<h5>Cris The Man<span>posted an update</span></h5>
								<div class="post-date">June 21, 2018</div>
								<p>Lorem ipsum dolor sit amet, cdictum nisl onsectetur adipisc ing ipsum dolor sit ame. Lorem ipsum dolor sit amet, consectetur adipisc ing ipsum dolor sit ame.Donec venenatis at eros sit amet aliquam. Donec vel orci efficitur, dictum nisl vitae, scelerisque nibh. Curabitur eget ipsum pulvinar nunc gravida interdum. </p>
					...
					<li>
						<div class="community-post">
							<div class="author-avator set-bg" data-setbg="{{ asset ('assets/frontend/img/authors/6.jpg') }}"></div>
							<div class="post-content">
								<h5>James Smith<span>posted an update</span></h5>
								<div class="post-date">June 21, 2018</div>
								<p>Lorem ipsum dolor sit amet, cdictum nisl onsectetur adipisc ing ipsum dolor sit ame. Lorem ipsum dolor sit amet, consectetur adipisc ing ipsum dolor sit ame.Donec venenatis at eros sit amet aliquam. Donec vel orci efficitur, dictum nisl vitae, scelerisque nibh. Curabitur eget ipsum pulvinar nunc gravida interdum. </p>
					...
					<li>
						<div class="community-post">
							<div class="author-avator set-bg" data-setbg="{{ asset ('assets/frontend/img/authors/7.jpg') }}"></div>
							<div class="post-content">
