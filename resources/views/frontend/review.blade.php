...
<body>
	...
	<!-- Page info section -->
	<section class="page-info-section set-bg" data-setbg="{{ asset ('assets/frontend/img/page-top-bg/3.jpg') }}">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="review-item">
						<div class="review-cover set-bg" data-setbg="{{ asset ('assets/frontend/img/review/5.jpg') }}">
				...
				<div class="col-md-6">
					<div class="review-item">
						<div class="review-cover set-bg" data-setbg="{{ asset ('assets/frontend/img/review/6.jpg') }}">
							<div class="score yellow">9.3</div>
						</div>
						<div class="review-text">
				...
				<div class="col-md-6">
					<div class="review-item">
						<div class="review-cover set-bg" data-setbg="{{ asset ('assets/frontend/img/review/7.jpg') }}">
							<div class="score yellow">9.3</div>
						</div>
						<div class="review-text">
							<h4>Avatar</h4>
				...
				<div class="col-md-6">
					<div class="review-item">
						<div class="review-cover set-bg" data-setbg="{{ asset ('assets/frontend/img/review/8.jpg') }}">
							<div class="score yellow">9.3</div>
						</div>
						<div class="review-text">
							<h4>Anthem</h4>
				...
				<div class="col-md-6">
					<div class="review-item">
						<div class="review-cover set-bg" data-setbg="{{ asset ('assets/frontend/img/review/9.jpg') }}">
							<div class="score yellow">9.3</div>
						</div>
						<div class="review-text">
				...
				<div class="col-md-6">
					<div class="review-item">
						<div class="review-cover set-bg" data-setbg="{{ asset ('assets/frontend/img/review/10.jpg') }}">
							<div class="score yellow">9.3</div>
						</div>
						<div class="review-text">
							<h4>Spiderman</h4>
	...
	<!-- Review section -->
	<section class="review-section review-dark spad set-bg" data-setbg="{{ asset ('assets/frontend/img/review-bg-2.jpg') }}">
		<div class="container">
